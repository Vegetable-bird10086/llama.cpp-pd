...
ggml_type llama_ftype_get_default_type(llama_ftype ftype) {
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_GPTQ2_32: return GGML_TYPE_GPTQ2_32;
        case LLAMA_FTYPE_MOSTLY_GPTQ2_64: return GGML_TYPE_GPTQ2_64;
        case LLAMA_FTYPE_MOSTLY_GPTQ2_128: return GGML_TYPE_GPTQ2_128;
...
static void llama_model_quantize_impl(const std::string & fname_inp, const std::string & fname_out, const llama_model_quantize_params * params) {
    ...
    llama_model_loader ml(/*metadata*/ nullptr, /*set_tensor_data*/ nullptr, /*set_tensor_data_ud*/ nullptr,
        fname_inp, splits, /*file*/ nullptr, /*external_buffer*/ nullptr,
        /*external_buffer_size*/ 0, use_mmap, /*use_direct_io*/ false,
